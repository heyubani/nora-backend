...
## nora Project Installation

    $ git clone https://github.com/heyubani/nora-backend.git
    $ cd nore-backend
    $ npm install
...
https://documenter.getpostman.com/view/14594801/2s8ZDVaPhZ
